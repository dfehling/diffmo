...
config.General.requestName = 'TTBar_Powheg10_v5_JESdown'
...
config.JobType.pyCfgParams = ['runOnData=0', 'JES=down', 'JER=nominal', 'includePDF=0', 'runOnCrab=1']
...
config.Data.outputDatasetTag = 'TTBar_Powheg10_v5_JESdown'
