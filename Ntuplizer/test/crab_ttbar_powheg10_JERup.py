...
config.General.requestName = 'TTBar_Powheg10_v5_JERup'
...
config.JobType.pyCfgParams = ['runOnData=0', 'JES=nominal', 'JER=up', 'includePDF=0', 'runOnCrab=1']
...
config.Data.outputDatasetTag = 'TTBar_Powheg10_v5_JERup'
